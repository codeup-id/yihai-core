...
class Modal extends BaseWidget
{
    ...
    protected function initOptions()
    {
        ...
        if ($this->toggleButton !== false) {
            if (!isset($this->toggleButton['options']))
                $this->toggleButton['options'] = [];
            $this->toggleButton['options']['data-toggle'] = 'modal';
    ...
    public static function dismissButton($options)
    {
        if(!isset($options['options']))
            $options['options'] = [];
        $options['options']['data-dismiss']='modal';
        return Button::widget($options);
    }

    public static function buttonToModal($id, $options = [])
    {
        $_options = [
            'data-toggle' => 'modal',
            'data-target' => $id
        ...
        if(isset($options['options']))
            $options['options'] = ArrayHelper::merge($options['options'], $_options);
        else
