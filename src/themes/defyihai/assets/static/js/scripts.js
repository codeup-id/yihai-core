    ...
    Layout.prototype.fixSidebar = function () {
        ...
        if (this.options.slimscroll) {
            if (typeof $.fn.slimScroll !== 'undefined') {
                ...
                var siteInfoHeight = $('.main-sidebar .site-info').height();
                // Add slimscroll
                $(Selector.sidebar).slimScroll({
                    height: ($(window).height() - $(Selector.mainHeader).height()) -(siteInfoHeight?siteInfoHeight:0) + 'px'
                });
            }
        }
    };
...
$(function () {
    ...
    function setup() {
        ...
        $('[data-skin]').on('click', function (e) {
            if ($(this).hasClass('knob'))
                return;
            e.preventDefault();
            $('#settings-form-skin-id').val($(this).data('skin'));
    ...
    $('#skins-list').append($('<div />').append('<h3 class="control-sidebar-heading">Skin</h3>').append($skinsList));
