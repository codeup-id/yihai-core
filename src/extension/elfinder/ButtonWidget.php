...
class ButtonWidget extends Widget{
	...
	public function run(){
		...
		$this->getView()->registerJs("codeup.elFinder.register(" . Json::encode($this->_managerOptions['id']) . ", " . Json::encode($this->callback) . ");"); // register callback Function
		$this->getView()->registerJs("\$(document).on('click', '#" . $this->options['id'] . "', function(){codeup.elFinder.openManager(" . Json::encode($this->_managerOptions) . ");});");//on click button open manager
	}
}